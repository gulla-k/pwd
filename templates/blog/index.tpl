					...
					<div class="container">
						<div class="col-md-12 col-md-offset-0">
							<div class="animate-box">
								<h2>Блог</h2>
								<p class="breadcrumbs"><span><a href="/">Home</a></span><span>\</span><span>Блог</span></p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-md-12 text-center">
						<ul class="pagination">
						    {% if posts.has_previous %}
						        <li><a href="/blog/page/{{ posts.previous_page_number }}"><<</a></li>
						    {% else %}
						    	<li class="disabled"><a><<</a></li>
						    {% endif %}

							{% if posts.number|add:'-4' > 1 %}
							    <li><a href="/blog/page/{{ posts.number|add:'-5' }}">...</a></li>
							{% endif %}
						    ...
						    {% if posts.has_next %}
						        <li><a href="/blog/page/{{ posts.next_page_number }}">>></a></li>
						    {% else %}
						    	<li class="disabled"><a>>></a></li>
						    {% endif %}
						</ul>
